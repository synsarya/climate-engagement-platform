...
import dottedWorldMap from 'figma:asset/649ed38e5c2f915692ba14a3d93e86d0f28d2f13.png';
import climateDataGif from 'figma:asset/fa4e365597fe5691d96561dcd64593ed0e59e0e9.png';
...
const powerPlantData = [
  // Solar
  { type: "solar", x: 28, y: 45, name: "Mojave Solar", capacity: "280 MW", country: "USA" },
  { type: "solar", x: 35, y: 68, name: "Noor Complex", capacity: "580 MW", country: "Morocco" },
  { type: "solar", x: 75, y: 52, name: "Kamuthi Solar", capacity: "648 MW", country: "India" },
  { type: "solar", x: 80, y: 75, name: "Kurnool Solar", capacity: "1000 MW", country: "Australia" },
  
  // Wind
  { type: "wind", x: 52, y: 30, name: "Hornsea One", capacity: "1200 MW", country: "UK" },
  { type: "wind", x: 25, y: 35, name: "Shepherds Flat", capacity: "845 MW", country: "USA" },
  { type: "wind", x: 78, y: 35, name: "Gansu Wind", capacity: "7965 MW", country: "China" },
  { type: "wind", x: 54, y: 30, name: "Kriegers Flak", capacity: "600 MW", country: "Denmark" },
  
  // Nuclear
  { type: "nuclear", x: 53, y: 38, name: "Flamanville", capacity: "1650 MW", country: "France" },
  { type: "nuclear", x: 22, y: 42, name: "Vogtle", capacity: "2234 MW", country: "USA" },
  { type: "nuclear", x: 85, y: 45, name: "Kashiwazaki", capacity: "8212 MW", country: "Japan" },
  { type: "nuclear", x: 75, y: 30, name: "Balakovo", capacity: "4000 MW", country: "Russia" },
  
  // Fossil Fuels
  { type: "fossil", x: 76, y: 40, name: "Tuoketuo", capacity: "6720 MW", country: "China" },
  { type: "fossil", x: 24, y: 45, name: "W.A. Parish", capacity: "3653 MW", country: "USA" },
  { type: "fossil", x: 74, y: 50, name: "Mundra", capacity: "4620 MW", country: "India" },
  { type: "fossil", x: 68, y: 25, name: "Surgut-2", capacity: "5597 MW", country: "Russia" }
];
...
export function InteractiveEarth() {
  ...
  const renderLegend = () => {
    ...
    if (activeView === "power") {
      return (
        <div className="space-y-2">
          <h4 className="font-medium text-sm">Power Plant Types</h4>
          <div className="space-y-1">
            <div className="flex items-center space-x-2">
              <div className="w-3 h-3 rounded flex items-center justify-center" style={{ backgroundColor: "#f59e0b" }}>
                <Sun className="h-2 w-2 text-white" />
              </div>
              <span className="text-xs">Solar</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-3 h-3 rounded flex items-center justify-center" style={{ backgroundColor: "#06b6d4" }}>
                <Wind className="h-2 w-2 text-white" />
              </div>
              <span className="text-xs">Wind</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-3 h-3 rounded flex items-center justify-center" style={{ backgroundColor: "#8b5cf6" }}>
                <Atom className="h-2 w-2 text-white" />
              </div>
              <span className="text-xs">Nuclear</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-3 h-3 rounded flex items-center justify-center" style={{ backgroundColor: "#ef4444" }}>
                <Factory className="h-2 w-2 text-white" />
              </div>
              <span className="text-xs">Fossil Fuel</span>
            </div>
          </div>
        </div>
      );
    ...
    <section className="py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl mb-4">Interactive Climate Data Globe</h2>
          <p className="text-muted-foreground max-w-3xl mx-auto">
            Explore real-time climate data from around the world. Click on data points to see detailed information 
            about temperature changes, CO₂ emissions, and power generation facilities.
          </p>
        </div>
            ...
            <Card className="h-[600px]">
              ...
              <CardContent className="h-full">
                {activeView === "historical" ? (
                  ...
                  <div className="relative w-full h-full bg-gradient-to-br from-blue-900 to-blue-800 rounded-lg overflow-hidden border">
                    {/* Earth Background */}
                    <div className="absolute inset-0">
                      <EarthSVG showCountries={true} />
                    </div>
                    ...
                    {/* Green pulse circles for online community members */}
                    {activeView === "community" && 
                      communityMembersData
                        ...
                        .map((member, index) => (
                          <motion.div
                            key={`pulse-${index}`}
                            className="absolute w-16 h-16 border-2 border-green-400 rounded-full pointer-events-none"
                            style={{
                              left: `${member.x}%`,
                              top: `${member.y}%`,
                              transform: 'translate(-50%, -50%)'
                ...
                <CardContent>
                  ...
                  {activeView === 'power' && (
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                      <div className="text-center">
                        <div className="text-2xl font-bold mb-2">{selectedPoint.capacity}</div>
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-sm text-muted-foreground mt-2">Energy Source</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold mb-2">{selectedPoint.country}</div>

          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div>
                ...
                <h1 className="text-3xl lg:text-4xl mb-4">{campaign.title}</h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  <div className="text-center p-4 bg-muted/50 rounded-lg">
                    <div className="text-2xl font-bold text-primary">{campaign.current}</div>
                    <div className="text-sm text-muted-foreground">of {campaign.goal} schools</div>
                  </div>
                  <div className="text-center p-4 bg-muted/50 rounded-lg">
                    <div className="text-2xl font-bold text-primary">{campaign.participants.toLocaleString()}</div>
                  ...
                  <div className="text-center p-4 bg-muted/50 rounded-lg">
                    <div className="text-2xl font-bold text-primary">Dec 2024</div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">{campaign.timeCommitment}</div>
                          </div>
                        </div>
                        <div className="flex items-center space-x-3">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Progress value={(campaign.current / campaign.goal) * 100} className="h-3" />
                  </div>
                  <Separator />
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2">
                        <span className="font-semibold">{campaign.organizer.name}</span>
